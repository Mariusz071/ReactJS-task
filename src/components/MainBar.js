      ...
      <header className='heading'>
        <nav>
          <ul className='heading__nav'>
            <li title='Iste Natus'className={this.state.activeIndex === 0 ? 'active': null} onClick={this.toggleActive.bind(this, 0)}><Link to='/'>Iste Natus</Link></li>
        ...
        <div className = 'user-panel'>
          <button className='user-panel__dropdown-menu'>
            <p>
              Veris Veritatis 
            </p>
          ...
          <button className='user-panel__user-initial'>
            <span>Z</span>
          </button>
        </div>
      </header>
